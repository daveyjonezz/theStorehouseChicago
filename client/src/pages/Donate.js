        ...
        <Container>
            ...
            <Row>
              ...
              <Col size="sm-12">
                <Fade left cascade duration={1500}>
                  ...
                  <img src="/images/jennidavis2.jpg" alt="jennidavis" style={{ height: "200px", padding: "10px 0" }} />
          ...
          {/* <Section background="merch3">
            <Row>
              <Col size="md-12">
                <Fade left cascade duration={1500}>
                  <img src="/images/adi3.jpg" alt="adi" style={{ height: "300px", padding: "10px" }} />
                  <img src="/images/jennidavis2.jpg" alt="jennidavis" style={{ height: "300px", padding: "10px 0" }} />
                  <img src="/images/jimi3.jpg" alt="jimi" style={{ height: "300px", padding: "10px" }} />
                </Fade>
